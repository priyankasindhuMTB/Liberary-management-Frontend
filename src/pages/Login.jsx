      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-6 shadow-xl shadow-slate-200/60 rounded-xl border border-slate-100">
            ...
            {error && (
              <div className="p-4 rounded-lg bg-red-50 border border-red-100 text-sm text-red-700">
                ...
                <div className="space-y-2 ml-6 text-xs leading-relaxed">
                  {errorCode === "NO_ADMIN" && (
                    <Link to="/register" className="block text-blue-600 hover:underline font-medium">
                      → Create a free account (7-day trial)
                    </Link>
                  )}
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center space-y-2">
            ...
            <Link to="/setup-super" className="text-xs text-slate-400 hover:text-slate-600 transition-colors">
              Setup System
            </Link>
          </div>
        </div>
