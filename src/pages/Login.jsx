  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.status === 200 && res.data) {
        ...
        // ✅ FCM token sync — login ke baad yahan call karo
        try {
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 border border-slate-300
                    ...
                    focus:ring-2 focus:ring-blue-500 sm:text-sm transition-all"
            ...
            <button
              ...
              className="w-full flex justify-center items-center py-2.5 px-4
                border border-transparent rounded-lg shadow-sm text-sm font-bold
