...
//             if (existing) {
//                 return prev.map(p =>
//                     p.shiftId === shiftId ? { ...p, amount: Number(value) } : p
//                 );
//             } else {
...
//         e.preventDefault();
//         try {
//             await axios.post("http://localhost:7000/api/createSeat", {
//                 seatNumber,
//                 price:priceData
//             });
...
//             setPriceData([])
//         } catch (error) {
//             setMessage(error.response?.data?.message || "Error creating seat");
//         }
//     };
// useEffect(() => {
//     fetchShifts();
...
//                 <h2 className="text-2xl font-bold mb-4 text-center text-black">Add New Seat</h2>
...
//                             key={shift._id}
//                             type="number"
//                             placeholder={`Price for ${shift.name}`}
